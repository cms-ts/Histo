...
double getEfficiencyMuonPOG(bool is2011A ,double muopt1 ,double muoeta1, double muopt2,double muoeta2){
  ...
  if (is2011A) {
    muoIDrunA={0.9111, 0.9429, 0.9661, 0.9398, 0.9639, 0.9789, 0.8731, 0.9665, 0.8643, 0.9777, 0.9616, 0.9334, 0.9614, 0.9499, 0.9164};
    ...
    muoIDrunB={0.8915, 0.8982, 0.9255, 0.9235, 0.9626, 0.9788, 0.8701, 0.9640, 0.8601, 0.9772, 0.9578, 0.9154, 0.9252, 0.9097, 0.8926};

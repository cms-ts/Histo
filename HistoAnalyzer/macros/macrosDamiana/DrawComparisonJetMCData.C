...
<<<<<<< DrawComparisonJetMCData.C
string plotpath;
string plotpathEle	="plotDataEle"+versionPath+"/";
string plotpathMu	="plotDataMu"+versionPath+"/";
...
void DrawComparisonJetMCData(void){
  ...
  outfilename=plotpath+"ratioPlotBgScale"+version;

#ifndef jetValidationWithPf_h
#define jetValidationWithPf_h
...
bool debugJet2=false; //If true it will activate the cout verbosity
...
class jetValidationWithPf : public edm::EDAnalyzer {
   public:
      explicit jetValidationWithPf(const edm::ParameterSet&);
      ~jetValidationWithPf();
   ...
   private:
      ...
      edm::InputTag electronCollectionSecond_;
...
//common ==================================
      ...
      TH2F * h_ptGsfPfGsfVspt;
      TH1F * h_totalPfElectronsVsEn;
      TH1F * h_PairedPfElectronsVsEn;
      TH1F * h_totalPfElectronsVsEta;
...
jetValidationWithPf::jetValidationWithPf(const edm::ParameterSet& conf)
...
// variable definition =========================
  ...
  electronCollectionSecond_ = conf.getUntrackedParameter<edm::InputTag>("electronCollectionSecond",edm::InputTag("gsfElectrons"));
...
//common ========================================================================
  ...
  h_ptGsfPfGsfVspt = fs->make<TH2F>("h_ptGsfPfGsfVspt","(ptGsf - ptPf) / ptGsf Vs pt",200,0,200,200,-1.,1.);
  if (doEfficiencies){
     h_totalPfElectronsVsEn = fs->make<TH1F>("h_totalPfElectronsVsEn","totalPfElectronsVsEn",10,0,200);
     h_PairedPfElectronsVsEn = fs->make<TH1F>("h_PairedPfElectronsVsEn","PairedPfElectronsVsEn",10,0,200);
     h_totalPfElectronsVsEta = fs->make<TH1F>("h_totalPfElectronsVsEta","totalPfElectronsVsEta",10,-2.5,2.5);
...
// histo about what there is around the electrons
  ...
  h_invMassGSF    = fs->make<TH1F>("h_invMassGSF","invMassGSF",60,60,120);
  ...
  h_sizeGsf = fs->make<TH1F>("h_sizeGsf","sizeGsf",3,0,3);
...
jetValidationWithPf::~jetValidationWithPf()
{

...
'keep recoCompositeCandidates_zmuMatchedmuMatched_*_PAT'
    )
process.out.outputCommands.extend(['keep recoCompositeCandidates_zmuMatchedmuMatched_*_PAT'
                                   ])

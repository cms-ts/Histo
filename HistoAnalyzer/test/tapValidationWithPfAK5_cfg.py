...
process.TAPhltele8NOTele17 = cms.EDFilter('EfficiencyFilter',
                           electronCollection = cms.InputTag("patElectronsWithTriggerele8NOTele17"),
                           superClusterCollection_EB = cms.InputTag("correctedHybridSuperClusters"),
                           superClusterCollection_EE = cms.InputTag("correctedMulti5x5SuperClustersWithPreshower"),
                           triggerCollectionTag = cms.untracked.InputTag("TriggerResults","","HLT"),
                           filename=cms.untracked.string("ZAnalysisFilter.root"),
...
switchOnTriggerMatchEmbedding( process
                               , triggerMatchers = [ 'eleTriggerMatchHLT' ]
                               , hltProcess = '*'
                               ) 

### ele8NOTele17
process.eleTriggerMatchHLTele8NOTele17 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                             src     = cms.InputTag( "patElectrons" ),
                                             matched = cms.InputTag( "patTrigger"),
                                             matchedCuts = cms.string('(path("HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v*",0,0) && (filter("hltEle17CaloIdIsoEle8CaloIdIsoPixelMatchDoubleFilter") && !filter("hltEle17CaloIdLCaloIsoVLPixelMatchFilter"))) || (path("HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v*",0,0) && (filter("hltEle17TightIdLooseIsoEle8TightIdLooseIsoTrackIsolDoubleFilter") && !filter("hltEle17TightIdLooseIsoEle8TightIdLooseIsoTrackIsolFilter")))'),
                                             maxDPtRel = cms.double( 5 ),
                                             maxDeltaR = cms.double( 0.3 ),
                                             resolveAmbiguities    = cms.bool( True ),
                                             resolveByMatchQuality = cms.bool( True )
...
process.patElectronsWithTriggerele8NOTele17 = cms.EDProducer("PATTriggerMatchElectronEmbedder",
                                                    src     = cms.InputTag("patElectrons"),
                                                    matches = cms.VInputTag(cms.InputTag('eleTriggerMatchHLTele8NOTele17'))
                                                 )

#switchOnTriggerMatching( process, ['eleTriggerMatchHLTele17' ],sequence ='patDefaultSequence', hltProcess = '*' )
switchOnTriggerMatchEmbedding( process
                               , triggerMatchers = [ 'eleTriggerMatchHLTele8NOTele17' ]
                               , hltProcess = '*'
                               ) 
...
process.TAPAnalysisHLTele8NOTele17 = cms.Path(
    process.eleTriggerMatchHLTele8NOTele17*
    process.patElectronsWithTriggerele8NOTele17*
